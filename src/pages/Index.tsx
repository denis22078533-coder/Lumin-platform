...
const NAV_ITEMS: { id: Tab; icon: string; label: string; badge?: number }[] = [
  { id: "feed", icon: "Home", label: "ÐÐµÐ½ÑÐ°" },
  { id: "events", icon: "Flag", label: "Ð¡Ð¾Ð±ÑÑÐ¸Ñ" },
  { id: "calendar", icon: "Calendar", label: "ÐÐ°Ð»ÐµÐ½Ð´Ð°ÑÑ" },
  { id: "chat", icon: "MessageCircle", label: "Ð§Ð°Ñ", badge: 31 },
  { id: "news", icon: "Newspaper", label: "ÐÐ¾Ð²Ð¾ÑÑÐ¸" },
  { id: "stats", icon: "BarChart2", label: "Ð¡ÑÐ°ÑÐ¸ÑÑÐ¸ÐºÐ°" },
  { id: "profile", icon: "User", label: "ÐÑÐ¾ÑÐ¸Ð»Ñ" },
];
